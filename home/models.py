...
class CovertedToDB(models.Model):
    ...
    Anomaly=models.CharField(max_length=100,null=True,blank=True)
    Ratio_Data=models.IntegerField(null=True,blank=True)
    ...
    Data_Volume_std=models.FloatField(null=True,blank=True)
    Voice_Affected_Users=models.IntegerField(null=True,blank=True)
    Voice_Affected_Users_Formula=models.FloatField(null=True,blank=True)
    Voice_Affected_Users_mean=models.IntegerField(null=True,blank=True)
    Voice_Affected_Users_std=models.FloatField(null=True,blank=True)
    HSI_Affected_Users=models.IntegerField(null=True,blank=True)
    HSI_Affected_Users_Formula=models.FloatField(null=True,blank=True)
    HSI_Affected_Users_mean=models.IntegerField(null=True,blank=True)
    HSI_Affected_Users_std=models.FloatField(null=True,blank=True)
    ...
    Indoor_Freqency_850=models.FloatField(null=True,blank=True)
    Indoor_Freqency_1800=models.FloatField(null=True,blank=True)
    Indoor_Freqency_2300=models.FloatField(null=True,blank=True)
    prb_20=models.CharField(max_length=10,null=True,blank=True)
    prb_70_90=models.CharField(max_length=10,null=True,blank=True)
    prb_90=models.CharField(max_length=10,null=True,blank=True)
    prb_20_per=models.CharField(max_length=10,null=True,blank=True)
    prb_70_90_per=models.CharField(max_length=10,null=True,blank=True)
    prb_90_per=models.CharField(max_length=10,null=True,blank=True)
    ...
    total_upc_generated=models.IntegerField(null=True,blank=True)                  
